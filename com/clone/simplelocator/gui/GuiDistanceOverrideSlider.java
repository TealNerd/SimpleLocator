...
public class GuiDistanceOverrideSlider extends GuiButton {
	...
	public GuiDistanceOverrideSlider(GroupConfiguration group, int par1,
			int par2, int par3, double maxDistance, boolean infinityAllowed,
 ...
 * 
 * Qualified Name: shadowjay1.forge.simplelocator.gui.GuiDistanceOverrideSlider
 * 
