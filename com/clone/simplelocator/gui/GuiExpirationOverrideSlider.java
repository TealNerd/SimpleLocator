...
public class GuiExpirationOverrideSlider extends GuiButton {
	...
	public GuiExpirationOverrideSlider(GroupConfiguration group, int par1,
			int par2, int par3, double maxTime, boolean infinityAllowed,
 ...
 * 
 * Qualified Name:
 * shadowjay1.forge.simplelocator.gui.GuiExpirationOverrideSlider
 * 
